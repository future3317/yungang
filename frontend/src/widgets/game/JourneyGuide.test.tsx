...
describe('ActionTargetGuide', () => {
  it('shows a route name and lets the player cancel target selection', () => {
    ...
    render(<ActionTargetGuide mode="restore_route" actions={[{ type: 'restore_route', label: '修护路线', route_id: 'route_shanhua_temple_yungang', cost: 1 }]} sites={{}} routes={{ route_shanhua_temple_yungang: { id: 'route_shanhua_temple_yungang', name: '善化寺—云冈石窟' } as never }} cards={{}} onRun={vi.fn()} onCancel={onCancel} />);
