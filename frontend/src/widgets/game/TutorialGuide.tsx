...
const steps = [
  { icon: Flag, eyebrow: '第 1 步 · 仰观全局', title: '让线索彼此照亮', body: '旅程顶部记录着众人共同追寻的目标。每回合开始时，看看队伍还缺哪一束线索，再决定谁沿哪条路前行。', cue: '共同目标 · 回合 · 共同影响' },
  { icon: MapPinned, eyebrow: '第 2 步 · 踏上路线', title: '沿着线索前往下一处节点', body: '行动点有限。移动会带你抵达新的节点，探索能取得证据，贡献则能把证据化为团队的影响。地图上的金色标记，是此刻可以抵达的去处。', cue: '左侧行动 · 地图上的金色路线' },
  ...
  { icon: Library, eyebrow: '第 4 步 · 取一件线索', title: '三件遗物，各自指向一条脉络', body: '公开市场呈现本回合可以带走的三件文化线索。金边线索能回应眼前的节点，其他线索可能为后续地点留下伏笔。每次寻访消耗 1 AP，线索会进入手牌。', cue: '公开市场 · 节点线索 · 后续伏笔' },
