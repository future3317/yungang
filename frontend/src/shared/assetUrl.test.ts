...
describe('assetUrl', () => {
  ...
  it('preserves named asset groups and absolute paths', () => {
    expect(assetUrl('generated/nodes/icon_node_yungang.webp')).toBe('/ui-assets/generated/nodes/icon_node_yungang.webp');
  ...
  it('uses the requested fallback only when the asset is empty', () => {
    expect(assetUrl(undefined, 'ornaments/heritage-medallion-1.webp')).toBe('/ui-assets/ornaments/heritage-medallion-1.webp');
  });
});
