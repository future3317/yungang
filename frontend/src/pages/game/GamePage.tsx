...
export function GamePage() {
  ...
  return <div className="game-shell">
    ...
    <CommandDock state={state} active={active} cards={cards} legal={legal} actionsByType={actionsByType} actionMode={actionMode} actionLabels={actionLabels} mutationPending={mutation.isPending} onRun={run} onChoose={chooseAction} onCancel={() => setActionMode(null)} onCard={setCard} onContribution={selectContribution} />
