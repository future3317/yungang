...
import { actionFeedback, actionLabels, actionModeLabel, findCardAction, localizeActionError, localizeActionText, optionAction, previewDeltaText, roleBadgeAsset, type ActionMode } from '../../widgets/game/gameUi';
...
export function GamePage() {
  ...
  const [completedTask, setCompletedTask] = useState<{ task: Task; siteName: string } | null>(null);
