...
export function MapEditor() {
  ...
  const position = (site: SiteReference) => layout[site.id] || { x: site.layout?.x ?? site.x ?? 50, y: site.layout?.y ?? site.y ?? 50 };
