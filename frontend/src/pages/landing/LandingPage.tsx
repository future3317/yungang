...
export function LandingPage() {
  ...
  async function create(event: FormEvent) {
    ...
    try {
      ...
      window.localStorage.setItem(`yungang-room-token:${result.room.room_id}`, result.seat_token);
