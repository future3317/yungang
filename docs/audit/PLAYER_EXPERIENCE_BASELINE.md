...
- The former fixed-session game endpoints and direct player-join endpoint are intentionally removed. Production creation uses `POST /api/rooms`; room membership uses the authenticated room flow.
