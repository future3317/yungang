...
如果你是第一次打开网页、还不确定每一步该点什么，请先看[第一次试玩手把手教程](FIRST_PLAYTHROUGH_GUIDE.md)，完成一条固定的“移动—探索—研判—干预—结束回合”小循环，再回来阅读本说明。

## 一、先用一句话理解项目

《石窟光谱》是一款以云冈石窟及大同文化遗产网络为主题的合作研判游戏。

云冈、华严寺和善化寺跨越不同历史时期。本项目地图是跨时代遗产研究网络，并非历史时期地图复原；游戏中的路线和区域用于组织比较、协作与保护决策，不表示同一时期的真实交通边界。
...
3. **右侧：地点详情**。这里可以查看当前地点的说明、任务、项目、事件和市场。
...
| 内容 | 数量 | 在游戏中的作用 |
| --- | ---: | --- |
| 场景 | 7 | 每个场景有不同的压力、路线、项目和事件组合 |
| 地点 | 28 | 地图上的遗产地点、研究入口和修护对象 |
| 路线 | 46 | 连接地点，也会被阻断、承压、修护和重新连接 |
