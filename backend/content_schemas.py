...
class SiteContract(ContentItemContract):
    ...
    map_shape: str | None = None

    historical_context: str | None = None

    gameplay_effect: str | None = None
...
class ScenarioContract(ContentItemContract):
    ...
    tutorial_unlock_schedule: list[JsonObject] = Field(default_factory=list)

    first_turn_allowed_actions: list[str] = Field(default_factory=list)

    selectable_role_ids: list[str] = Field(default_factory=list)
...
class SourcesContract(BaseModel):
